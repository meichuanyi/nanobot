...
nanobot is an **open-source and ultra-lightweight AI agent** in the spirit of OpenClaw, Claude Code, and Codex. It keeps the core agent loop small while supporting chat channels, memory, MCP and practical deployment.

### Key Features

| Feature | Description |
|---------|-------------|
| 🐄 Ultra-lightweight | Small, readable core |
| 🧠 Memory System | Dream two-stage persistence |
| 🔌 MCP Support | Tools and resources |
| 🌐 25+ Channels | Discord, Telegram, Feishu, Slack, WeChat, QQ, Email |
| 🛡️ Sandbox | Production-ready |
...
42+ providers: OpenAI, Anthropic, Google, DeepSeek, Azure, AWS Bedrock, GitHub Copilot, OpenRouter, Moonshot, MiniMax, StepFun, Ollama, vLLM.
