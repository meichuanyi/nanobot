...
| 🌐 Multi-channel | Discord, Telegram, Feishu, Slack, WeChat, QQ, Email, Matrix, DingTalk |
| 🛡️ Sandbox | Production-ready sandboxing for safe code execution |
| 📊 Observability | Langfuse, LangSmith integration |
| 🎯 /goal command | Holds sustained objectives across turns |
| 🖥️ WebUI | Built-in web interface for chat and settings |
| 📦 Plugin Skills | ClawHub skill marketplace |

### How does nanobot compare to other AI agent frameworks?

| Framework | Type | Key Advantages |
|-----------|------|----------------|
| nanobot | Lightweight Agent | Ultra-small core, multi-channel, memory, MCP, Python-first |
| OpenClaw | Agent Framework | TypeScript-first, skills, channels, gateway architecture |
| Claude Code | AI Coding Agent | Anthropic-native, focused on code |
| CrewAI | Multi-Agent | Role-playing agents, Python orchestration |
...
### What channels (chat platforms) are supported?
...
nanobot has native MCP support, allowing your agent to connect to external tools, resources, and prompts. You can configure multiple MCP servers for different capabilities.

### Memory System

nanobot features a **Dream two-stage memory** system:
- Stage 1: Token-based working memory
- Stage 2: Long-term persistence with skill discovery
...
- 📱 [Feishu Group](./COMMUNICATION.md)
- 📱 [WeChat Group](./COMMUNICATION.md)
- 𝕏 [Twitter](https://twitter.com/nanobot_project)
